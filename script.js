...
// ===== Scroll → hide navbar di page 1 & terakhir =====
...
if (copyBtn1) copyBtn1.addEventListener('click', () => navigator.clipboard.writeText('1640005528270').then(() => alert('Number 1 copied!')));
if (copyBtn2) copyBtn2.addEventListener('click', () => navigator.clipboard.writeText('3450508143').then(() => alert('Number 2 copied!')));
